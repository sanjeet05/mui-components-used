...
/*
* this content header can have two parameter
* 1. type @ leftText
* 2. text @ rightText
* EX: <ZTechContentHeader leftText="Dashboard" rightText="Dashboard / Executive" />
*/

const ZTechContentHeader = (props) => {
  return (
    <Grid fluid>
...
export default ZTechContentHeader;
